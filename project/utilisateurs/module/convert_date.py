...
def convert(date_):
    ...
    date_debut_format = datetime.datetime.strptime(date_,format_date)
    date_ = datetime.datetime(date_debut_format.year,date_debut_format.month, date_debut_format.day)
    return date_
